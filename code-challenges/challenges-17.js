...
const recursionPattern = (int1, int2) => {
    ...
    let res=[];
    function recursion(x,y,bool){if(bool==true){

        if(x==int1){res.push(x);
        }
        else{res.push(x);
          recursion(x+y,y,true);
        }
      }
      else{if(x<0){recursion(x,y,true)}
        else{res.push(x);
          recursion(x-y,y,false);
        }
      }
    }
    recursion(int1,int2,false);
    return res;
}
// -------------------------------------------------------------------------------------------------------
